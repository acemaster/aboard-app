    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JSONObject json = sr.getJSON("http://powerful-tor-5829.herokuapp.com/login",params);
                if(json != null){
                try{
                String jsonstr = json.getString("response");
                    if(json.getBoolean("res")){
                        ...
                        edit.commit();
                        Intent profactivity = new Intent(LoginActivity.this,Tabview.class);
                ...
                cont.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                      ...
                      //  JSONObject json = sr.getJSON("http://192.168.56.1:8080/api/resetpass", params);
                        JSONObject json = sr.getJSON("http://powerful-tor-5829.herokuapp.com/api/resetpass", params);
                        if (json != null) {
                            try {
                                String jsonstr = json.getString("response");
                                if(json.getBoolean("res")){
                                ...
                                cont_code.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        JSONObject json = sr.getJSON("http://powerful-tor-5829.herokuapp.com/api/resetpass/chg", params);
